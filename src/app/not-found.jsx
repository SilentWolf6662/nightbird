// `app/not-found.jsx` is the UI for the `404` URL
'use client'
			...
			<main className='bg-background text-primary'>
				<section className='relative h-full flex-col justify-center items-center'>
					<div className='flex justify-center items-center pt-20'>
						...
						<Image
							src={record}
							className='w-32 h-32 hidden unselectable'
						/>
						<h2 className='font-greatVibes text-[10rem]'>4</h2>
					</div>
					<div className='flex flex-col justify-center items-center pt-10'>
						<h2 className='text-6xl font-greatVibes text-center capitalize'>
							Opps!
						</h2>
						<p className='text-2xl text-center'>
							Sorry, The page you are looking for is not found or
							doesn't
						</p>
						<p className='text-2xl text-center'>
				...
				<section className='relative h-full flex-col justify-center items-center'></section>
			</main>
		</>
	)
}
